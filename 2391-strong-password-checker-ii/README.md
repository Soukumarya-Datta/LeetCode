<h2><a href="https://leetcode.com/problems/strong-password-checker-ii/description/">2391. Strong Password Checker II</a></h2><h3>Easy</h3><hr><p>A password is said to be <strong>strong</strong> if it satisfies all the following criteria:</p>
